import { ComponentVersion, Graph, Interface, Relation } from "@gropius/graph-editor";
import { parse } from "yaml";
import { Model } from "./model";
import { componentStyles, interfaceStyles, relationStyles } from "./styles";

export function parseModel(model: string): LayoutGraph {
...
export interface LayoutComponentVersion extends ComponentVersion {
    template: string;
    interfaces: LayoutInterface[];
}

export interface LayoutInterface extends Interface {
    template: string;
}

export interface LayoutRelation extends Relation {
    template: string;
}

export interface LayoutGraph extends Graph {
    components: LayoutComponentVersion[];
